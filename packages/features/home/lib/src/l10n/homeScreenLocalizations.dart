...
import 'homeScreenLocalizations_en.dart';
...
///
/// ```dart
/// import 'l10n/homeScreenLocalizations.dart';
///
/// return MaterialApp(
...
abstract class HomeScreenLocalizations {
  ...
  /// No description provided for @appbarLabelHome.
  ///
  /// In en, this message translates to:
  /// **'Home'**
  String get appbarLabelHome;

  /// No description provided for @bottomAppbarLabelIncome.
  ///
  /// In en, this message translates to:
  /// **'+'**
  String get bottomAppbarLabelIncome;

  /// No description provided for @bottomAppbarLabelExpense.
  ///
  /// In en, this message translates to:
  /// **'-'**
  String get bottomAppbarLabelExpense;

  /// No description provided for @bottomAppbarLabelTransfer.
  ///
  /// In en, this message translates to:
  /// **'Tr'**
  String get bottomAppbarLabelTransfer;
}
